...
class AdherentImportType extends AbstractType
{
	/**
	 * @var Annee
	 */
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
			...
			->add('fichier', 'file', array(
					'label' => 'patlenain_gas.common.file',
					'attr' => array('class' => 'fileupload')))
            ->add('import', 'submit', array(
            		'label' => 'patlenain_gas.common.import',
    ...
    {
        return 'patlenain_gasbundle_adherent_import';
    }
}
